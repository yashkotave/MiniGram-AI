...
export default function Authentication() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-orange-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-pink-500 to-orange-500 px-6 py-8 text-center">
            <h1 className="text-4xl font-bold text-white mb-2">MiniGram</h1>
          ...
          <div className="px-6 py-8">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center space-x-2 text-gray-700 dark:text-gray-300"
                >
